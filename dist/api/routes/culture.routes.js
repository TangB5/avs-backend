...
const culture_service_1 = require("@/modules/culture/application/culture.service");
const PrismaCultureRepository_1 = require("@/modules/culture/infrastructure/PrismaCultureRepository");
...
const repository = new PrismaCultureRepository_1.PrismaCultureRepository(database_1.db);
const service = new culture_service_1.CultureService(repository);
const controller = new culture_controller_1.CultureController(service);
/**
 * @swagger
 * /api/v1/patterns:
 *   get:
 ...
 */
router.get('/:slug', security_middleware_1.publicApiRateLimiter, controller.getBySlug);
/**
 * @swagger
 * /api/v1/patterns:
 *   post:
 ...
 *         $ref: '#/components/responses/NotFound'
 */
router.patch('/:id/publish', auth_middleware_1.authenticate, auth_middleware_1.requireCurator, controller.publish);
/**
 * @swagger
 * /api/v1/patterns/{id}:
 *   delete:
 ...
 *         $ref: '#/components/responses/NotFound'
 */
router.delete('/:id', auth_middleware_1.authenticate, auth_middleware_1.requireAdmin, controller.remove);
